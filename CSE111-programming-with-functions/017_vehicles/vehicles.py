def main():
    ...
    vehicles_dict = {
        ...
        "WWDA": [2002, "Jeep", "Liberty", "blue", "V6", 3.7],
        "ASDA": [2002, "Mazda", "626", "white", "I4", 2.0],
    ...
    if vin in vehicles_dict:
        ...
        values = vehicles_dict[vin]

        # Print the manufacturer, model, and color of the vehicle.
        print (f"Manufecture: {values[MANUFACTURER_INDEX]}, Model: {values[MODEL_INDEX]}, Color: {values[COLOR_INDEX]}")
