...
def print_death_age(people_dict):
    ...
    for person in people_dict:
        print(f"{people_dict[person][NAME_INDEX]} was {people_dict[person][DEATH_YEAR_INDEX] - people_dict[person][BIRTH_YEAR_INDEX]} years old at death.")
...
def count_genders(people_dict):
    ...
    for person in people_dict:
        if people_dict[person][GENDER_INDEX] == "M": count_male += 1
        else: count_female += 1
    print (f"Count of male: {count_male}, Count of female: {count_female}")
